...
import org.hexworks.zircon.api.loadFontTilesetResource
...
class KorgeTrueTypeFontTileset(
    ...
    init {
        require(resource.tileType == CHARACTER_TILE) {
            "True Type Font tilesets only support ${CHARACTER_TILE.name}s. The supplied resource's type was ${resource.tileType.name}."
        }
    }
