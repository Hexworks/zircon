...
class Position3DTest {
    ...
    companion object {
        ...
        val POS = Position3D.of(9, 9, 1)

        val POS_WITH_LESSER_Z = Position3D.of(8, 8, 0)
        val POS_WITH_GREATER_Z = Position3D.of(8, 8, 2)

        val POS_WITH_EQUAL_Z_LESSER_Y = Position3D.of(8, 8, 1)
        val POS_WITH_EQUAL_Z_GREATER_Y = Position3D.of(8, 10, 1)

        val POS_WITH_EQUAL_Z_AND_Y_LESSER_X = Position3D.of(8, 9, 1)
        val POS_WITH_EQUAL_Z_AND_Y_GREATER_X = Position3D.of(10, 9, 1)
    }
}
