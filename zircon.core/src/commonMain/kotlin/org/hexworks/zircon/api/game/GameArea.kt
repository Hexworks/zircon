 ...
 * The space is composed of [Block]s that are just voxels (like in Minecraft) with 6 sides
 * (all optional), and a content [Tile] within the voxel itself (optional as well).
...
interface GameArea<T : Tile, B : Block<T>> : Scrollable3D, Disposable {
     ...
     * if [position] is outside the [actualSize] of this [GameArea].
     */
