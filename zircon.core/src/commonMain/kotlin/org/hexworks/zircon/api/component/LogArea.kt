...
/**
 * A [LogArea] provides the possibility to display a stream of messages. The messages are
 * composed of log elements that can be, for instance, text or other Zircon components.
 * New rows have to be explicitly created by calling [LogArea.addNewRows].
 *
