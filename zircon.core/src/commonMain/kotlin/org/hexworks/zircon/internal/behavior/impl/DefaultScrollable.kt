...
class DefaultScrollable internal constructor(
    ...
    override val actualSizeProperty =
        initialActualSize.toProperty(optionalName = "Scrollable:actualSize", validator = { _, newSize ->
            newSize.toRect().containsBoundable(visibleSize.toRect())
        })
    override var actualSize: Size by actualSizeProperty.asDelegate()

    override val visibleOffsetProperty = Position.zero().toProperty(optionalName = "Scrollable:visibleOffset", validator = { _, newPos ->
