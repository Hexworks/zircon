...
class KorGECP437Tileset(
    ...
    override fun drawTile(tile: Tile, surface: KorGECP437DrawSurface, position: Position) {
        surface.drawTile(tile as CharacterTile, position)
    }
}