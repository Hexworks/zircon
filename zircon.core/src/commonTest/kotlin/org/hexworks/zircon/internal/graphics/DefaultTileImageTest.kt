...
class DefaultTileImageTest {
    ...
    fun shouldProperlyGetEmptyTile() {
        IMAGE_3X3.getTileAtOrNull(EMPTY_POS) shouldBe null
    }
    ...
    fun shouldProperlyResizeToSmaller() {
        ...
        result.tiles.toMap() shouldBe mapOf(Position.create(0, 0) to FILLER_TILE_A)
    }
    ...
    fun shouldProperlyFill() {
        ...
        result.fetchCharacters() shouldContainExactly listOf(
            'a', 'a', 'a',
            'a', 'a', 'b',
            'a', 'a', 'a'
        )
    ...
    fun shouldProperlyTransform() {
        ...
        result.tiles.values.toSet() shouldContainExactly listOf(NEW_TILE_B)
    }
    ...
    fun shouldProperlyWithStyle() {
        ...
        result.tiles.values.toSet() shouldContainExactly listOf(
            characterTile {
                +'a'
                styleSet = style
            }
    ...
    fun shouldProperlyWithTileset() {
        ...
        (result.tileset == tileset) shouldBe true
    }
