...
class DefaultLogAreaTest : ComponentImplementationTest<DefaultLogArea>() {
    ...
    fun shouldProperlyAddNewRow() {
        target.addNewRows(1)
        target.children.size shouldBe 1
    }
    ...
    fun shouldProperlyAddNewText() {
        ...
        (paragraph as Paragraph).text shouldBe TEXT
    }
    ...
    fun shouldProperlyAddComponent() {
        ...
        target.children.size shouldBe 1
        child.children.first() shouldBe testComponent
    }
    ...
    fun shouldProperlyRemoveComponentIfItGetsDisposedDueToHistorySize() {
        ...
        (target.children as Iterable<InternalComponent>) shouldNotContain testComponent
    }
    ...
    fun logElementShouldProperlyScrollDownIfNecessary() {
        ...
        child.children.shouldBeEmpty() // this means it has no paragraph as a child
    }
