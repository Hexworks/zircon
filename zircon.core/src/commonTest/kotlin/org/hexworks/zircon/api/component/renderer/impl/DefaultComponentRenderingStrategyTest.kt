...
class DefaultComponentRenderingStrategyTest {
    ...
    fun shouldRenderButtonWithDecorations() {
        ...
        graphics.tiles.values.map { (it as? CharacterTile)?.character } shouldContainExactly listOf(
            '┌', '─', '─', '─', '─', '─', '┐', '_',
            '│', '[', 'q', 'u', 'x', ']', '│', '░',
            '└', '─', '─', '─', '─', '─', '┘', '░',
            '_', '░', '░', '░', '░', '░', '░', '░'
    ...
    fun shouldNotRenderButtonWhenItIsInvisible() {
        ...
        graphics.fetchCharacters() shouldContainExactly MutableList(32) { ' ' }
    }
    ...
    fun `Should properly render decorations and the component on a blank TileGraphics`() {
        ...
        graphics.fetchCharacters() shouldContainExactly listOf(
            '┌', '─', '┐', ' ',
            '│', 'b', '│', '░',
            '└', '─', '┘', '░',
            ' ', '░', '░', '░'
