...
import org.hexworks.zircon.api.extensions.asGraphicalTileOrNull
import org.hexworks.zircon.api.extensions.asImageTileOrNull
...
class DefaultStackedTileTest {
    ...
    private fun StackedTile.assertAsOtherTile(expectedCharTile: Tile) {
        val charTile = this.top.asCharacterTileOrNull()
        val imageTile = this.top.asImageTileOrNull()
        val graphicTile = this.top.asGraphicalTileOrNull()
        assertTrue(imageTile == null, "The stack should not be convertible to ImageTile")
        assertTrue(graphicTile == null, "The stack should not be convertible to GraphicalTile")
        assertTrue(charTile != null, "Stack should be convertible to CharacterTile")
