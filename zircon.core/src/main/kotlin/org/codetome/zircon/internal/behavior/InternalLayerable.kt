 ...
 * (which are specialized [org.codetome.zircon.api.graphics.TileImage]s) overlays above the grid.
 */
interface InternalLayerable : Layerable, Dirtiable, FontOverrideSupport {
     ...
     */
    fun fetchOverlayZIntersection(absolutePosition: Position) : List<Pair<Tileset, Tile>>
