...
import org.codetome.zircon.internal.grid.ApplicationListener
import org.codetome.zircon.internal.grid.InternalTileGrid

/**
 * This is the class implements the [ApplicationListener] for the
 * [InternalTileGrid].
 */
@Suppress("unused")
abstract class ApplicationTileGrid(
        private val deviceConfiguration: DeviceConfiguration,
        private val terminal: InternalTileGrid,
        private val checkDirty: Boolean = true)
    : InternalTileGrid by terminal, ApplicationListener {
    ...
    /**
     * Used when requiring the total height of the grid component, in pixels.
     */
    abstract fun getHeight(): Int

    /**
     * Used when requiring the total width of the grid component, in pixels.
     */
