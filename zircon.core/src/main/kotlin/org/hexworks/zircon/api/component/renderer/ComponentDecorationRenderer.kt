...
interface ComponentDecorationRenderer : DecorationRenderer<ComponentDecorationRenderContext> {
    ...
    /**
     * Calculates the [Position] this renderer offsets the [TileGraphics]. For example in the case of
    ...
    /**
     * Calculates the [Size] this [ComponentDecorationRenderer] is occupying. For example a Box renderer
     * has an `occupiedSize` of `Size(2, 2)` since it takes up 2 columns (left, right)
     * and 2 rows (top, down).
     */
    fun occupiedSize(): Size
}
