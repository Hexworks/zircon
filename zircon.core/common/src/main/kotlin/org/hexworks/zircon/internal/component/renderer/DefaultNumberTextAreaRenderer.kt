...
class DefaultNumberTextAreaRenderer : ComponentRenderer<DefaultNumberTextArea> {

    override fun render(tileGraphics: SubTileGraphics, context: ComponentRenderContext<DefaultNumberTextArea>) {
