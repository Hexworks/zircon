...
fun gridFillByScreenSize(screenWidth: Int, screenHeight: Int, tileWidth: Int, tileHeight: Int) =
    Size.create(screenWidth / tileWidth, screenHeight / tileHeight - VERTICAL_HEIGHT_OFFSET)
