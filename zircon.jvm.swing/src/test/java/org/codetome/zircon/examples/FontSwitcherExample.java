...
public class FontSwitcherExample {
    ...
    public static void main(String[] args) {
        ...
        TILESETS.add(CP437TilesetResource.ADU_DHABI_16X16);
        TILESETS.add(CP437TilesetResource.ROGUE_YUN_16X16);
        TILESETS.add(CP437TilesetResource.REX_PAINT_16X16);
        TILESETS.add(CP437TilesetResource.WANDERLUST_16X16);
        TILESETS.add(CP437TilesetResource.BISASAM_16X16);
