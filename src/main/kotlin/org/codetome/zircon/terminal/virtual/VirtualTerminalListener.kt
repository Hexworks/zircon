 ...
 * [org.codetome.zircon.terminal.Terminal.addResizeListener], in that case only the
 * resize event will fire on the listener.
 */
interface VirtualTerminalListener : TerminalResizeListener {
    /**
     * Called when the [org.codetome.zircon.terminal.Terminal.flush] method is invoked on the [VirtualTerminal].
     */
    fun onFlush()

    /**
     * Called when the [org.codetome.zircon.terminal.Terminal.close] method is invoked on the [VirtualTerminal].
     */
    fun onClose()
}
