...
/**
 * Controls how the bold [org.codetome.zircon.Modifier] will take effect when enabled on a character. Mainly this is controlling if the
...
enum class BoldMode {
    ...
    EVERYTHING,
    /**
     * All characters with bold [org.codetome.zircon.Modifier] enabled, except for the characters defined as constants in Symbols class, will
