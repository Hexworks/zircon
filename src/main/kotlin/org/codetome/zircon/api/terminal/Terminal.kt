 ...
 * and standard error (System.err) and it's usually through printing title only.
...
interface Terminal
     ...
     * [Terminal.putCharacter] will print out a title string without the need
     * to reposition the title cursor. If you reach the end of the line while putting characters
     * using this method, you can expect the title cursor to move to the beginning of the next line.
     *
