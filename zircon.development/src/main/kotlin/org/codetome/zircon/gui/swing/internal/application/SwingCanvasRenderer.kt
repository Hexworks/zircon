package org.codetome.zircon.gui.swing.internal.application
...
import org.codetome.zircon.gui.swing.internal.impl.SwingTilesetLoader
import org.codetome.zircon.gui.swing.internal.tileset.transformer.toAWTColor
    ...
    private fun renderTiles(graphics: Graphics,
        ...
        tiles.forEach { (pos, tile) ->
            if (tile !== Tile.empty()) {
                ...
                val actualTileset: Tileset<Tile, BufferedImage> = if (actualTile is TilesetOverride) {
                    actualTile.tileset() as Tileset<Tile, BufferedImage>
                } else {
